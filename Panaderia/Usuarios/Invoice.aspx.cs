...
namespace Panaderia.Usuarios
{
    public partial class Invoice : System.Web.UI.Page
    {
        ...
        protected void lbDownloadInvoice_Click(object sender, EventArgs e)
        {
            try
            {
                string downloadPath = @"D:\Recibos\Order_invoice.pdf";
                DataTable dtbl = GetOrderDetails();
                ExportToPdf(dtbl, downloadPath, "Recibo del pedido");
        ...
        void ExportToPdf(DataTable dtblTable, String strPdfPath, string strHeader)
        {
            ...
            prgAuthor.Add(new Chunk("\nFecha de Pedido : " + dtblTable.Rows[0]["OrderDate"].ToString(), fntAuthor));

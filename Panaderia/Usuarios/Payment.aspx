<%@ Page Title="" Language="C#" MasterPageFile="~/Usuarios/Usuario.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="Panaderia.Usuarios.Payment" %>
        ...
        <div class="container py-5">
            ...
            <div class="row mb-4">
                <div class="col-lg-8 mx-auto text-center">
                    <h1 class="display-6">Orden de Pago</h1>
                </div>
            </div>
            <!-- End -->
            <div class="row pb-5">
                <div class="col-lg-6 mx-auto">
                    <div class="card ">
                        <div class="card-header">
                            <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                                ...
                                <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3">
                                    ...
                                    <li class="nav-item"><a data-toggle="pill" href="#paypal" class="nav-link "><i class="fa fa-money mr-2"></i>Pago en Efectivo </a></li>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="credit-card" class="tab-pane fade show active pt-3">
                                    <div role="form">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtName" runat="server" CssClass="form-control" placeholder="Nombre del dueño"></asp:TextBox>
                                        </div>
                                        <div class="form-group">
                                            <label for="txtCardNo">
                                            ...
                                            <div class="input-group">
                                                <asp:TextBox ID="txtCardNo" runat="server" CssClass="form-control" placeholder="Numero de Tarjeta"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtAddress" runat="server" CssClass="form-control" placeholder="Direccion del delivery"
                                        ...
                                        <div class="card-footer">
                                            <asp:LinkButton ID="lbCardSubmit" runat="server" CssClass="subscribe btn btn-info btn-block shadow-sm"
                                                ValidationGroup="card" OnClick="lbCardSubmit_Click">Confirmar Pago</asp:LinkButton>
                                        </div>
                                    </div>
                                </div>
                                <!-- End -->
                                ...
                                <div id="paypal" class="tab-pane fade pt-3">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtCODAddress" runat="server" CssClass="form-control" placeholder="Direccion de la entrega"
                                    ...
                                    <p>
                                        <asp:LinkButton ID="lbCodSubmit" runat="server" CssClass="btn btn-info" ValidationGroup="cod" OnClick="lbCodSubmit_Click">
                                            <i class="fa fa-cart-arrow-down mr-2"></i>Confirmar Pedido</asp:LinkButton>
                                    </p>
                                    <p class="text-muted">
                                        Note: Al recibir su pedido, debe realizar el pago completo. 
                        ...
                        <div class="card-footer">
                            <b class="badge badge-success badge-pill shadow-sm">Order Total: S/. <% Response.Write(Session["grandTotalPrice"]); %> </b>
                            <div class="pt-1">

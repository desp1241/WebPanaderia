    ...
    public partial class Producto : System.Web.UI.Page
    {
        ...
        protected void btnAddOrUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (isValidToExecute)
            {
                ...
                try
                {
                    con.Open();
                    cmd.ExecuteNonQuery();
                    actionName = productId == 0 ? "agregado" : "actualizado";
                    lblMsg.Visible = true;
                    lblMsg.Text = "Producto " + actionName + " exitosamente";
        ...
        protected void rProduct_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                {
                    lblIsActive.Text = "Validado";
                    lblIsActive.CssClass = "badge badge-success";
                }
                else
                {
                    lblIsActive.Text = "Sin Validar";
                ...
                if (Convert.ToInt32(lblQuantity.Text) <= 5) 
                {
                    ...
                    lblQuantity.ToolTip = "Producto cerca a estar sin stock";
                }
            }
        }
    }

<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Users.aspx.cs" Inherits="Panaderia.Admin.Users" %>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton ID="lnkDelete" Text="Eliminar" runat="server" CommandName="delete"
                                                                        ...
                                                                        OnClientClick="return confirm('¿Seguro que desea eliminar este Usuario?');">
                                                                            <i class="ti-trash"></i>
                                                                    </asp:LinkButton>
                                                                </td>
                                                            </tr>
